    ...
    <div className="min-h-screen bg-[#FDFCF6]">
      ...
      <div className="relative w-full h-[400px] md:h-[520px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center px-6">
          <Link to="/#properties" className="text-white/90 flex items-center gap-2 mb-6 hover:text-white transition-colors">
          ...
          <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 px-4 py-2 rounded-full">
            ...
            <span className="text-white text-sm font-medium">Mayapur, West Bengal, India</span>
          </div>
        </div>
      </div>
          ...
          {bhkOptions.map((option, index) => (
            ...
            >
              ...
              <div className="p-8 pb-6">
                <h3 className="text-2xl md:text-3xl font-bold text-[#4A3427] mb-2">{option.title}</h3>
                <p className="text-secondary font-bold text-sm tracking-wider uppercase">{option.size}</p>
              </div>
              ...
              <div className="relative grid grid-cols-2 h-[300px] md:h-[350px] bg-[#f8f8f8] border-y border-gray-100">
                ...
                {option.images.map((img, idx) => (
                  ...
                  >
                    ...
                    {/* Image Adjustment: object-contain ensures the whole plan is visible */}
                    <img
                      src={img}
                ...
                <div className="mt-auto pt-6 border-t border-gray-100">
                  <ul className="grid grid-cols-2 gap-4">
                    {option.features.map(f => (
                      <li key={f} className="flex items-start gap-2 text-sm font-bold text-[#4A3427]">
      ...
      {/* CALL TO ACTION SECTION (Inspired by your screenshot) */}
      <div className="container-custom pb-24">
        <div className="bg-[#8B5E3C] rounded-[3rem] p-12 text-center text-white shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 relative z-10">Inquire About Your Future Home</h2>
